...
export const GetInTouchSection = ({
  ...
  return (
    <IsNotSameUserWrapper projectUserId={projectUserId}>
      <div className="relative mt-6 flex w-full flex-col items-center justify-center gap-4 overflow-clip rounded-xl border border-[#1F5D2B] bg-radial-gradient p-10 pt-16">
